...
| `output`                                          | `js`                                   | Directory where the compiled files will be written                                  |
|                                                   | `{`                                    |                                                                                     |
|                                                   | `  path: '[cwd]/dist',`                |                                                                                     |
...
| `optimization`                                    | `js`                                   | Splits vendor dependencies and keeps the runtime chunk separated                    |
|                                                   | `{`                                    |                                                                                     |
|                                                   | `  splitChunks: {`                     |                                                                                     |
|                                                   | `    chunks: 'all'`                    |                                                                                     |
|                                                   | `  },`                                 |                                                                                     |
...
| `devServer`                                       | `js`                                                           | Serve static assets from the `public` directory.                                                           |
|                                                   | `{`                                                            |                                                                                                            |
